...
class BallRepository {
  ...
  Future<int?> get sharingAnimationDuration async => (await _pref).getInt(_sharingAnimationDurationKey);
  Future<int?> get floatingAnimationDuration  async => (await _pref).getInt(_floatingAnimationDurationKey);
  Future<String?> get sharingAnimationCurve async => (await _pref).getString(_sharingCurveKey);
  Future<String?> get floatingAnimationCurve async => (await _pref).getString(_floatingCurveKey);
  Future<bool?> get voiceAssistantEnable async => (await _pref).getBool(_voiceAssistantEnableKey);
  Future<String?> get currentSoundTitle async => (await _pref).getString(_currentSoundKey);
  Future<int?> get textTransition async => (await _pref).getInt(_textTransitionKey);
